    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          Container(height: 15,),
          _getInfoRow("Phone:", widget.driver.phone),
          Container(height: 5,),
          _getInfoRow("Email:", widget.driver.email),
          Container(height: 5,),
          _getInfoRow("Active:", (_active??false).toString()),
          Container(height: 5,),
          Opacity(
            ...
            child: FlatButton(
              ...
              child: Text(_active??false?"Deactivate":"Activate", style: TextStyle(color: Colors.white),),
